...
void delay_line_main() {
	...
	printf("\n");
	printf("Enter Relative Path To WAV File: ");
    char file_path[1000];
	scanf("%s", file_path); 
	float *fdata = retrieve_data(&input, file_path);
...
void convolution_reverb_main() {
	...
	printf("\n");
	printf("Enter Relative Path To WAV File: ");
    char in_file_path[1000];
	scanf("%s", in_file_path); 
	float *finput = retrieve_data(&input, in_file_path);
	printf("\n");
	printf("IMPULSE WAV FILE:\n");
	printf("---------------");
	printf("\n");
	printf("Enter Relative Path To WAV File: ");
    char im_file_path[1000];
	scanf("%s", im_file_path); 
	float *fimpulse = retrieve_data(&impulse, im_file_path);
